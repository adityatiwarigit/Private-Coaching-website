...
<body>
    ...
    <section id="menubar">
        ...
        ?>
            ...
            <div id="mySidenav" class="sidenav" style="font-size:16px;">
                ...
                <a href="11th.php?logout=true">Log Out</a>
            </div>
    ...
    <section id="web-content" class="container-fluid">
        ...
        <div id="eight" class="container-fluid">
            <?php
            $sql_query = "select id,class,video_link,Discription,language from democlasses where class = '11';";
            $result = mysqli_query($conn, $sql_query);
            while ($row = mysqli_fetch_array($result)) {
            ?>
                <h2>This the Demo Session For Class 11th <?php echo $row['language'] ?> Medium Students.</h2>
                <div>
