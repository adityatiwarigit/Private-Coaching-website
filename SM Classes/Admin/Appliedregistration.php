            ...
            <table class="table"style="color:white;">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Profile img link</th>
                ...
                ?>
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $row['profileimg_link'] ?></td>
                            <td><button class="btn btn-success"><a href="update.php?id=<?php echo $row['id'] ?>" style="text-decoration:none;color:white;">Edit</a></button></td>
                            <form action="Appliedregistration.php" method="POST">
                                <td><button type="submit" class="btn btn-success" value="<?php echo $row['id'] ?>" name="delete-btn">Delete</button></td>
                            </form>
                        </tr>
                    </tbody>
